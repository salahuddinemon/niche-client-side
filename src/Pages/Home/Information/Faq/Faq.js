...
const Faq = () => {
    ...
    return (
        <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4 mt-3">
            <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 md:leading-7 leading-9 text-gray-800">Frequently Asked Questions</h2> <br /> <hr />
            <div className="mt-10 flex md:justify-between md:items-start md:flex-row flex-col justify-start items-start">
                <div className=" ">
