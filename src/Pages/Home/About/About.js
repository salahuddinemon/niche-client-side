        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 ">At SunglassHut, our aim is to offer you various category sunglasses that show you that we really care! Not only have we got the trendiest sunglasses, but we can also guarantee that they are of the finest quality. <br /> <br />
                        We at SunglassHut believe in high quality and exceptional customer service. But most importantly, we believe shopping is a right, not a luxury, so we strive to deliver the best products at the most affordable prices, and ship them to you regardless of where you are located.
                    </p>
                </div>
